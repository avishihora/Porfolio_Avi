...
import SandL from "../../assets/images/Snake&Ladder.jpg";
        ...
        <div className="nft">
          <div className="main">
            ...
            <div className="creator">
              ...
              <p>
                <ins>Created by</ins>{" "}
                <a href="https://github.com/avishihora/Project1">Avi Shihora</a>
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="nft">
          <div className="main">
            ...
            <div className="creator">
              ...
              <p>
                <ins>Created By</ins> Avi Shihora - Chailcy Patel - Dinisha Soni
              </p>
            </div>
          </div>
        </div>
